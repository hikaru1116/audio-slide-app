...
# アルゼンチン
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_001"},"id":{"S":"quiz_flag_001"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/ar.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/ar.mp3"},"correctAnswer":{"S":"アルゼンチン"},"choices":{"L":[{"S":"アルゼンチン"},{"S":"ブラジル"},{"S":"メキシコ"},{"S":"コロンビア"}]},"category":{"S":"flags"},"explanation":{"S":"アルゼンチンの国旗は白地に青いスパイクと黄色い太陽があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# イギリス
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_002"},"id":{"S":"quiz_flag_002"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/gb.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/gb.mp3"},"correctAnswer":{"S":"イギリス"},"choices":{"L":[{"S":"イギリス"},{"S":"フランス"},{"S":"ドイツ"},{"S":"スペイン"}]},"category":{"S":"flags"},"explanation":{"S":"イギリスの国旗は白地に赤い十字架があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# 日本
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_003"},"id":{"S":"quiz_flag_003"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/jp.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/jp.mp3"},"correctAnswer":{"S":"日本"},"choices":{"L":[{"S":"日本"},{"S":"韓国"},{"S":"中国"},{"S":"タイ"}]},"category":{"S":"flags"},"explanation":{"S":"日本の国旗は白地に赤い丸（日の丸）です。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# アメリカ
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_004"},"id":{"S":"quiz_flag_004"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/us.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/us.mp3"},"correctAnswer":{"S":"アメリカ"},"choices":{"L":[{"S":"アメリカ"},{"S":"カナダ"},{"S":"イギリス"},{"S":"オーストラリア"}]},"category":{"S":"flags"},"explanation":{"S":"アメリカの国旗は星条旗と呼ばれ、50の星と13の縞模様があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# ブラジル
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_005"},"id":{"S":"quiz_flag_005"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/br.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/br.mp3"},"correctAnswer":{"S":"ブラジル"},"choices":{"L":[{"S":"ブラジル"},{"S":"アルゼンチン"},{"S":"メキシコ"},{"S":"コロンビア"}]},"category":{"S":"flags"},"explanation":{"S":"ブラジルの国旗は緑地に黄色い菱形と青い円があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# パプアニューギニア
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_006"},"id":{"S":"quiz_flag_006"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/pg.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/pg.mp3"},"correctAnswer":{"S":"パプアニューギニア"},"choices":{"L":[{"S":"パプアニューギニア"},{"S":"オーストラリア"},{"S":"ニュージーランド"},{"S":"フィジー"}]},"category":{"S":"flags"},"explanation":{"S":"パプアニューギニアの国旗は青地に白い十字架と赤い星があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# インドネシア
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_007"},"id":{"S":"quiz_flag_007"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/id.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/id.mp3"},"correctAnswer":{"S":"インドネシア"},"choices":{"L":[{"S":"インドネシア"},{"S":"マレーシア"},{"S":"フィリピン"},{"S":"シンガポール"}]},"category":{"S":"flags"},"explanation":{"S":"インドネシアの国旗は白地に赤いスパイクと青い円があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# 韓国
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_008"},"id":{"S":"quiz_flag_008"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/kr.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/kr.mp3"},"correctAnswer":{"S":"韓国"},"choices":{"L":[{"S":"韓国"},{"S":"日本"},{"S":"中国"},{"S":"タイ"}]},"category":{"S":"flags"},"explanation":{"S":"韓国の国旗は白地に赤い太陽と青い太陽があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# スウェーデン
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_009"},"id":{"S":"quiz_flag_009"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/se.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/se.mp3"},"correctAnswer":{"S":"スウェーデン"},"choices":{"L":[{"S":"スウェーデン"},{"S":"ノルウェー"},{"S":"デンマーク"},{"S":"スペイン"}]},"category":{"S":"flags"},"explanation":{"S":"スウェーデンの国旗は白地に青い十字架があります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'

# インド
aws dynamodb put-item --endpoint-url $DYNAMODB_ENDPOINT --table-name Quiz --item '{"PK":{"S":"CATEGORY#flags"},"SK":{"S":"QUIZ#quiz_flag_010"},"id":{"S":"quiz_flag_010"},"questionImageUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/images/flags/in.png"},"questionAudioUrl":{"S":"https://audio-slide-app.s3.ap-northeast-1.amazonaws.com/audio/flags/in.mp3"},"correctAnswer":{"S":"インド"},"choices":{"L":[{"S":"インド"},{"S":"パキスタン"},{"S":"バングラデシュ"},{"S":"ネパール"}]},"category":{"S":"flags"},"explanation":{"S":"インドの国旗は黄、橙、白、緑、青、赤の6色のパターンがあります。"},"createdAt":{"S":"'$TIMESTAMP'"},"updatedAt":{"S":"'$TIMESTAMP'"}}'
